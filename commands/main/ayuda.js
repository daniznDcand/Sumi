...
const COMMANDS_URL = 'https://api.stellarwa.xyz/src/comandos.js';
...
const command = commands.find(
  cmd =>
    ...
    cmd.alias.map(a => a.toLowerCase().replace(/^\//, "")).includes(commandName)
      ...
      const commandInfo = `✎ Información del comando *${commandName}*

➭ *Nombre ::* ${command.alias[0]}
> ꕥ *Descripción ::* ${command.desc}
> ✾ *Categoría ::* ${command.category || 'otros'}
> ✰ *Alías ::* ${command.alias.join(', ')}
> ✿ *Uso ::* ${command.uso ? command.uso : 'No disponible'}`;
